...
mspms 50 500 -t 1000 -r 1000 10000 > neutral_data_msprime.txt
...
do
    # Make selected data
    echo "~/src/discoal/discoal 50 500 1000 -ws 0 -Pa 1000 2500 -x $x -t 1000 -r 1000 > hard_$WIN.discoal" >> simcommands.txt
    echo "~/src/discoal/discoal 50 500 1000 -ws 0 -Pa 1000 2500 -x $x -Pf 0.1 0.5 -t 1000 -r 1000 > soft_$WIN.discoal" >> simcommands.txt
...
parallel --jobs 40 < simcommands.txt
parallel --jobs 40  < fveccommands.txt
...
python3 diploSHIC.py makeTrainingSets neutral_data_msprime_features.txt softTraining/soft hardTraining/hard 5 0,1,2,3,4,6,7,8,9,10 training_out
